...
/***/ "./src/exercicio-form/form-control.ts":
/*!********************************************!*\
  !*** ./src/exercicio-form/form-control.ts ***!
  \********************************************/
...
function hideErrorMessages(form) {
    form.querySelectorAll(".".concat(SHOW_ERROR_MESSAGES)).forEach(function (item) {
...
function shouldSendForm(form) {
    var send = true;
    form.querySelectorAll(".".concat(SHOW_ERROR_MESSAGES)).forEach(function () { return (send = false); });
    return send;
}
...
/*!*****************************************!*\
  !*** ./src/exercicio-form/exercicio.ts ***!
  \*****************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/exercicio-form/form-control.ts");
